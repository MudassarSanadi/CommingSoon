...
const MachineCard: React.FC<{
  ...
  delay?: number;
  visible?: boolean;
}> = ({ machine, color, onClick, delay = 0, visible = true }) => {
  ...
  return (
    ...
    >
      <div className="relative h-64 md:h-72 bg-gray-100 overflow-hidden">
        ...
        <div
          className={`absolute top-2 left-2 w-8 h-8 rounded-lg ${c.bg500} flex items-center justify-center shadow-md transition-transform duration-300 group-hover:scale-110`}
        >
      ...
      <div className="p-4">
        <span
          className={`inline-block text-[10px] font-semibold uppercase tracking-wide ${c.text600} mb-1`}
        >
          {machine.category}
        </span>
        ...
        <span
          className={`inline-block mt-2 text-[11px] font-medium ${c.text600} group-hover:underline transition-all duration-300`}
        >
          View Details →
        </span>
      </div>
          ...
          <div className="space-y-3">
            {machine.detailedInfo.map((line, i) => (
              <div
                ...
                style={{
                  animation: visible
                    ? `fadeInUp 0.4s ease-out ${i * 60 + 100}ms both`
                    : undefined,
                }}
              >
                <div
                  className={`w-1.5 h-1.5 rounded-full ${c.bg500} mt-2 shrink-0`}
                />
...
const IndustryDetailPage: React.FC<IndustryDetailPageProps> = ({
  setCurrentPage,
}) => {
  ...
  const heroImages: Record<string, string> = {
    manufacturing:
      "https://i.pinimg.com/736x/c2/03/f0/c203f0f2ca090e28d38c375f6591fe9f.jpg",
    dairy:
      "https://i.pinimg.com/1200x/23/7d/4c/237d4c85c92e6ac7235f782c8073df77.jpg",
    retail:
      "https://i.pinimg.com/1200x/52/bc/a2/52bca2af216c16bd480dd3d815713ff7.jpg",
    healthcare:
      "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1600&h=500&fit=crop&q=80",
  ...
  const milkMachines: MachineItem[] = [
    {
      ...
      description:
        "HTST & batch pasteurization, 500–10,000+ LPH capacity for safe, shelf-stable milk.",
      detailedInfo: [
      ...
      icon: Thermometer,
      image:
        "https://i.pinimg.com/736x/77/7f/d8/777fd87dac81d0793e54fd9c19328042.jpg",
    },
    {
      name: "Milk Homogenizer",
      category: "Processing Equipment",
      description:
        "High-pressure, two-stage homogenization for uniform fat distribution and smooth texture.",
      detailedInfo: [
      ...
      icon: Waves,
      image:
        "https://www.dtfoodmachine.com/wp-content/uploads/2025/09/milk-homogenizer.jpg",
    },
    {
      name: "Plate Heat Exchanger",
      category: "Processing Equipment",
      description:
        "Chiller, heater & heat recovery system for efficient thermal treatment of milk.",
      detailedInfo: [
      ...
      icon: GitBranch,
      image:
        "https://i.pinimg.com/736x/27/a4/be/27a4be1582ca6c0af4c06f5ff0f3dfab.jpg",
    },
    {
      name: "CIP System",
      category: "Utility & Automation",
      description:
        "Automated cleaning-in-place system ensuring plant-wide hygiene without disassembly.",
      detailedInfo: [
      ...
      icon: Settings,
      image:
        "https://www.hrs-heatexchangers.com/wp-content/uploads/2016/09/CIP3.jpg",
    },
    {
      name: "Dairy Valve Cluster",
      category: "Utility & Automation",
      description:
        "Automatic mix-proof valve battery for contamination-free product routing.",
      detailedInfo: [
      ...
      icon: CircleDot,
      image:
        "https://i.pinimg.com/736x/fe/ad/2e/fead2ea8a302382e8d59b8cc56b39b72.jpg",
    },
    {
      name: "Milk Reception Dock (RMRD)",
      category: "Reception & Storage",
      description:
        "Weigh, filter, chill and store incoming raw milk at the point of entry.",
      detailedInfo: [
      ...
      icon: Truck,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpXfFjdF7yDzHh8eubPCwYJhulTPT0bAmrV_KHxeVTUdjSF4uNzXAz864&s=10",
    },
    {
      name: "Milk Storage Silo & Tanks",
      category: "Reception & Storage",
      description:
        "Insulated storage from 1,000L to 100,000L+ for raw and processed milk.",
      detailedInfo: [
      ...
      icon: Warehouse,
      image:
        "https://i.pinimg.com/1200x/a2/40/af/a240afc72e12736b313db75bfafd7b23.jpg",
    },
    {
      name: "Cream Separator",
      category: "Processing & Utility",
      description:
        "Fat standardization & clarification through high-speed centrifugal separation.",
      detailedInfo: [
      ...
      icon: Gauge,
      image:
        "https://i.pinimg.com/736x/d1/7f/5b/d17f5b6f98ea920c33c56b39a5973e01.jpg",
    },
    {
      name: "Bulk Milk Cooler (BMC)",
      category: "Processing & Utility",
      description:
        "Village-level chilling to 4°C, preserving milk freshness at the collection stage.",
      detailedInfo: [
      ...
      icon: Milk,
      image:
        "https://5.imimg.com/data5/SELLER/Default/2021/10/CS/AU/GC/7782392/bulk-milk-cooler-bmc--500x500.jpg",
    },
    {
      name: "Milk Chilling Plant",
      category: "Processing & Utility",
      description:
        "Central chilling systems for large-scale, plant-wide temperature control.",
      detailedInfo: [
      ...
      icon: Thermometer,
      image:
        "https://5.imimg.com/data5/LF/BP/MY-5433941/milk-chilling-plant-500x500.jpg",
    },
    {
      name: "Cheese & Paneer Vat",
      category: "Processing & Utility",
      description:
        "Cutting & stirring vats designed for consistent curd formation and yield.",
      detailedInfo: [
      ...
      icon: FlaskConical,
      image:
        "https://goma.co.in/uploads/equipments/842bd71a0229d9677fcd86f4f86c8093.jpg",
    },
    {
      name: "Butter Churn",
      category: "Processing & Utility",
      description:
        "Continuous butter making system for high-throughput, consistent output.",
      detailedInfo: [
      ...
      icon: Package,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4yyzulkqB1mpjskly-eFnw0XEXCNl7sj2Xq1FRp9pNk6xgMbCdp3tEmk7&s=10",
    },
  ];
  ...
  const byProductMachines: MachineItem[] = [
    {
      ...
      description:
        "Complete Ghee production line with clarification, boiling, and packaging.",
      detailedInfo: [
      ...
      icon: Coffee,
      image:
        "https://5.imimg.com/data5/SELLER/Default/2022/2/IA/RZ/GY/680498/ghee-plant-500x500.JPG",
    },
    {
      name: "Butter Plant Machinery",
      category: "By-Product Processing",
      description:
        "Complete butter production line from cream churning to packaging.",
      detailedInfo: [
      ...
      icon: Package,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJLKWNbvQUx_eLz_NWy3mqAs7hhega-jaohf89SddcoXurDtOLAOgKRWc&s=10",
    },
    {
      name: "Paneer & Chhena Plant",
      category: "By-Product Processing",
      description:
        "Paneer and Chhena production line with curd setting and pressing.",
      detailedInfo: [
      ...
      icon: Sandwich,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRD24fmt3ysBxC4MNFnFMfigzE_MlU0FrvsqfjvnS1jKw&s",
    },
    {
      name: "Curd & Yogurt Plant",
      category: "By-Product Processing",
      description:
        "Curd and Yogurt production line with incubation and cooling.",
      detailedInfo: [
      ...
      icon: Milk,
      image:
        "https://5.imimg.com/data5/SELLER/Default/2025/9/545845666/NI/BA/OE/142534/curd-yogurt-buttermilk-plant-500x500.jpg",
    },
    {
      name: "Lassi Plant",
      category: "By-Product Processing",
      ...
      icon: Droplet,
      image:
        "https://5.imimg.com/data5/SU/DM/NV/SELLER-2051008/curd-lassi-plant-500x500.jpg",
    },
    {
      name: "Cream Separator",
      category: "By-Product Processing",
      description:
        "High-speed centrifugal cream separation for fat standardization.",
      detailedInfo: [
    ...
    },
    {
      ...
      category: "By-Product Processing",
      description:
        "Khoya/Mawa production system with continuous cooking and cooling.",
      detailedInfo: [
      ...
      icon: Wheat,
      image:
        "https://5.imimg.com/data5/YF/YZ/DR/SELLER-79448625/steam-operated-khoya-plant-500x500.jpg",
    },
    {
      name: "Ice Cream Plant",
      category: "By-Product Processing",
      description:
        "Complete ice cream production line from mix preparation to freezing.",
      detailedInfo: [
      ...
      icon: IceCream,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFIPx9JNsbSeePNBkRVM58HwIyvSYaG07jFPUzbgxNs0kNTYiL3TMyL-M&s=10",
    },
    {
      name: "Flavoured Milk Plant",
      category: "By-Product Processing",
      description:
        "Flavoured milk production line with flavoring and packaging.",
      detailedInfo: [
        "Milk standardization and pasteurization system.",
      ...
      icon: Coffee,
      image:
        "https://5.imimg.com/data5/QX/AW/MY-3778663/flavoured-milk-plant.jpeg",
    },
    {
      ...
      icon: Sandwich,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTrBj5op5ESOi5tBydx75G52bK4RY914TreztAzJSYoWjiviIyc8LjgmQ&s=10",
    },
    {
      name: "Yogurt Plant System",
      category: "By-Product Processing",
      description:
        "Specialized yogurt production with fruit and flavor integration.",
      detailedInfo: [
      ...
      icon: Croissant,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdLzeIOXa4PNWGCeQwjcMnXkzn_L_axncpyqlKyCLs-tIqODwtOvIwFCE&s=10",
    },
    {
      name: "Dairy Mixing & Blending System",
      category: "Utility & Automation",
      description:
        "Centralized blending system for all by-products with recipe management.",
      detailedInfo: [
  ...
  const industryData: Record<string, any> = {
    manufacturing: {
      ...
      description:
        "Complete manufacturing execution system (MES) for production tracking, quality control, and inventory management.",
      longDescription:
        "Our manufacturing solution provides end-to-end production management, from raw material procurement to finished goods dispatch. Real-time monitoring, quality control checkpoints, and automated reporting help you optimize production and reduce downtime.",
      stats: [
      ...
      features: [
        ...
        },
        {
          ...
          description:
            "Live production metrics and machine performance tracking",
          icon: Activity,
        },
        {
          title: "Quality Control System",
          description: "Automated quality checks at every production stage",
          icon: ClipboardCheck,
        },
        {
          title: "Inventory Management",
          description: "Raw material WIP and finished goods tracking",
          icon: Package,
        },
        {
        ...
        },
        {
          ...
          description: "Worker productivity attendance and skill tracking",
          icon: Users,
        },
        {
        ...
        },
        {
          ...
          description: "Custom reports and real-time business insights",
          icon: BarChart3,
        },
      ],
      benefits: [
    ...
    dairy: {
      ...
      description:
        "Complete dairy ecosystem management from farm collection to payment processing.",
      longDescription:
        "Transform your dairy operations with our comprehensive platform. From farmer management to milk testing, automated billing, and supply chain optimization, we provide end-to-end solutions for modern dairy businesses.",
      stats: [
      ...
      features: [
        {
          ...
          description:
            "Complete farmer profiles production history and GPS mapping",
          icon: Users,
        },
        {
          title: "Milk Collection System",
          description:
            "Automated collection center management with mobile apps",
          icon: Database,
        },
        {
          title: "Quality Testing Integration",
          description: "Fat/SNF testing and automated quality grading",
          icon: ClipboardCheck,
        },
        {
          title: "Smart Billing Engine",
          description: "Automated payment calculations and bank integration",
          icon: TrendingUp,
        },
        {
          title: "Cold Chain Monitoring",
          description: "Temperature monitoring and real-time alerts",
          icon: Shield,
        },
        {
          title: "Transport Logistics",
          description: "Route optimization and GPS vehicle tracking",
          icon: Truck,
        },
        {
          title: "Feed & Inventory",
          description: "Cattle feed management and sales tracking",
          icon: Package,
        },
        {
          title: "Cloud Analytics",
          description: "Real-time dashboards and business insights",
          icon: BarChart3,
        },
      ],
      benefits: [
    ...
    retail: {
      ...
      description:
        "Modern retail management platform with POS, inventory control, and CRM.",
      longDescription:
        "Empower your retail business with our integrated platform. Manage multiple stores, track inventory in real-time, analyze customer behavior, and optimize your supply chain with powerful analytics.",
      stats: [
      ...
      features: [
        {
          ...
          description: "Fast intuitive checkout with multi-payment support",
          icon: Smartphone,
        },
        {
          title: "Multi-store Management",
          description:
            "Centralized control of all locations from one dashboard",
          icon: Store,
        },
        {
          title: "Real-time Inventory",
          description: "Live stock tracking across all stores and warehouses",
          icon: Package,
        },
        {
          title: "Customer CRM",
          description: "Loyalty programs purchase history and targeted offers",
          icon: Users,
        },
        {
          title: "Supplier Portal",
          description: "Automated reordering and vendor performance tracking",
          icon: Truck,
        },
        {
          title: "Sales Analytics",
          description: "Performance reports trends and profit analysis",
          icon: BarChart3,
        },
        {
          title: "E-commerce Integration",
          description: "Sync online and offline inventory seamlessly",
          icon: Cloud,
        },
        {
          title: "Mobile Manager App",
          description: "Real-time alerts and business overview on mobile",
          icon: Smartphone,
        },
      ],
      benefits: [
    ...
    healthcare: {
      ...
      description:
        "HIPAA-compliant healthcare management system for clinics and hospitals.",
      longDescription:
        "Modernize your healthcare practice with our comprehensive platform. Manage patient records, schedule appointments, process billing, and ensure compliance with healthcare regulations.",
      stats: [
      ...
      features: [
        {
          ...
          description:
            "Centralized digital health records with access controls",
          icon: Database,
        },
        {
          title: "Appointment Scheduling",
          description: "Online booking automated reminders and calendar sync",
          icon: Calendar,
        },
        {
          title: "Patient Portal",
          description:
            "24/7 access to health records test results and messaging",
          icon: Users,
        },
        {
          title: "Billing & Insurance",
          description:
            "Automated invoicing insurance claims and payment tracking",
          icon: TrendingUp,
        },
        {
          title: "Prescription Management",
          description:
            "Digital prescriptions e-prescribing and refill tracking",
          icon: ClipboardCheck,
        },
        {
          title: "Lab Integration",
          description: "Test ordering result integration and lab management",
          icon: Activity,
        },
        {
          title: "Telemedicine",
          description:
            "Video consultations remote monitoring and e-prescriptions",
          icon: Cloud,
        },
        {
          title: "Compliance & Security",
          description: "HIPAA-ready audit logs and data encryption",
          icon: Shield,
        },
      ],
      benefits: [
    ...
    "milk-plant-machinery": {
      ...
      description:
        "Comprehensive dairy plant machinery covering processing, utility automation, and reception & storage.",
      longDescription:
      ...
      modules: [
        ...
        {
          name: "Processing & Utility Module",
          status: "Advanced",
          features: 5,
        },
      ],
    ...
    "milk-by-product-machinery": {
      ...
      description:
        "Comprehensive machinery for Ghee, Butter, Paneer, Curd, Lassi, Cream Separator, Khoya, Ice Cream, Flavoured Milk, Cheese & Yogurt.",
      longDescription:
        "Our milk by-product machinery line delivers complete processing solutions for dairy manufacturers. From Ghee and Butter to Paneer, Cheese, Yogurt, and Ice Cream, we provide end-to-end equipment that ensures consistent quality, operational efficiency, and full regulatory compliance.",
      stats: [
  ...
  const hasCategory = (cat: string) =>
    !!industry.machines &&
    industry.machines.some((m: MachineItem) => m.category === cat);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Logic Shell ${industry.name} solutions - ${industry.tagline}. Explore our comprehensive digital solutions for ${industry.name} industry.`}
        />
        <link
          rel="canonical"
          href={`https://thelogicshell.com/industry/${industryId}`}
        />
        ...
        <meta
          ...
          content={`Logic Shell ${industry.name} solutions - ${industry.tagline}.`}
        />
        <meta
          property="og:url"
          content={`https://thelogicshell.com/industry/${industryId}`}
        />
        <meta
          property="og:image"
          content="https://thelogicshell.com/favicon.svg"
        />
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: "Home",
                item: "https://thelogicshell.com/",
              },
              {
                "@type": "ListItem",
                position: 2,
                name: "Industry",
                item: "https://thelogicshell.com/industry",
              },
              {
                "@type": "ListItem",
                position: 3,
                name: industry.name,
                item: `https://thelogicshell.com/industry/${industryId}`,
              },
            ],
          })}
        </script>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
              ...
              <div
                ...
                style={{
                  ...
                  transition:
                    "opacity 0.7s ease-out 100ms, transform 0.7s ease-out 100ms",
                }}
              >
              ...
              <p
                ...
                style={{
                  ...
                  transform: heroLoaded ? "translateY(0)" : "translateY(20px)",
                  transition:
                    "opacity 0.7s ease-out 220ms, transform 0.7s ease-out 220ms",
                }}
              >
                {industry.tagline}
              </p>
            ...
            >
              {industry.stats.map((stat: any, i: number) => (
                <div
                  ...
                  style={{
                    animationDelay: statsSection.inView
                      ? `${i * 100}ms`
                      : undefined,
                  }}
                >
                  <div
                    className={`w-10 h-10 md:w-12 md:h-12 rounded-xl ${c.bg50} flex items-center justify-center mx-auto mb-2 md:mb-3`}
                  >
                    <stat.icon
                      size={20}
                      className={`${c.text500} md:w-5.5 md:h-5.5`}
                    />
                  </div>
                  <div
                    className={`text-xl md:text-2xl lg:text-3xl font-bold ${c.text600}`}
                  >
                    {stat.value}
                  </div>
            ...
            {hasCategory("By-Product Processing") && (
              <section className="py-6 md:py-8 bg-gray-50/50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div
                    ref={byProductSection.ref}
                    className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5"
                  >
                    {industry.machines
                      .filter(
                        (m: MachineItem) =>
                          m.category === "By-Product Processing",
                      )
                      .map((machine: MachineItem, i: number) => (
                        <MachineCard
                          key={i}
                          ...
                          onClick={() => setActiveMachine(machine)}
                          delay={i * 100}
                          visible={byProductSection.inView}
                        />
                      ))}
                  </div>
                </div>
            ...
            {hasCategory("Utility & Automation") && (
              <section className="py-6 md:py-8 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div
                    ref={utilitySection.ref}
                    className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5"
                  >
                    {industry.machines
                      .filter(
                        (m: MachineItem) =>
                          m.category === "Utility & Automation",
                      )
                      .map((machine: MachineItem, i: number) => (
                        <MachineCard
                          key={i}
            ...
            {hasCategory("Reception & Storage") && (
              <section className="py-6 md:py-8">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div
                    ref={receptionSection.ref}
                    className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5"
                  >
                    {industry.machines
                      .filter(
                        (m: MachineItem) =>
                          m.category === "Reception & Storage",
                      )
                      .map((machine: MachineItem, i: number) => (
                        <MachineCard
                          key={i}
                          ...
                          onClick={() => setActiveMachine(machine)}
                          delay={i * 100}
                          visible={receptionSection.inView}
                        />
                      ))}
                  </div>
                </div>
            ...
            {hasCategory("Processing & Utility") && (
              <section className="py-6 md:py-12 bg-gray-50/50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="mb-4">
                    <h2 className="text-xl md:text-2xl font-bold text-gray-900">
                      Processing & Utility Equipment
                    </h2>
                  </div>
                  <div
                    ref={processingUtilitySection.ref}
                    className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5"
                  >
                    {industry.machines
                      .filter(
                        (m: MachineItem) =>
                          m.category === "Processing & Utility",
                      )
                      .map((machine: MachineItem, i: number) => (
                        <MachineCard
                          key={i}
                          ...
                          onClick={() => setActiveMachine(machine)}
                          delay={i * 80}
                          visible={processingUtilitySection.inView}
                        />
                      ))}
                  </div>
                </div>
          ...
          <section className="py-10 md:py-16">
            ...
            >
              <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
                <div
                  className={
                    overviewSection.inView ? "reveal-visible" : "reveal-hidden"
                  }
                >
                    ...
                    <div className="grid grid-cols-2 gap-3 md:gap-4">
                      {industry.benefits.map((benefit: any, i: number) => {
                        ...
                        return (
                          <div
                            key={i}
                            className="text-center p-2 md:p-3 bg-white rounded-lg border border-gray-100 transition-transform duration-300 hover:-translate-y-0.5"
                          >
                            <div
                              className={`text-base md:text-xl font-bold ${bc.text600}`}
                            >
                              {benefit.metric}
                            </div>
                ...
                <div
                  ...
                  style={{
                    animationDelay: overviewSection.inView
                      ? "150ms"
                      : undefined,
                  }}
                >
                  ...
                  <div className="space-y-3 max-h-100 md:max-h-125 overflow-y-auto pr-2 custom-scrollbar">
                    {industry.features.map((feature: any, i: number) => (
                      <div
                        key={i}
                        className="flex items-start gap-3 p-3 md:p-4 bg-white rounded-xl border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all duration-300"
                      >
                        <div
                          className={`w-7 h-7 md:w-8 md:h-8 rounded-lg ${c.bg50} flex items-center justify-center shrink-0`}
                        >
                          <feature.icon
                            size={14}
                            className={`${c.text500} md:w-4 md:h-4`}
                          />
                        </div>
                        <div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-6 md:mb-8">
              ...
              <p className="text-gray-500 text-sm md:text-base">
                Comprehensive modules designed for your business needs
              </p>
            </div>
            <div
            ...
            >
              {industry.modules.map((module: any, i: number) => (
                <div
                  ...
                  style={{
                    animationDelay: modulesSection.inView
                      ? `${i * 100}ms`
                      : undefined,
                  }}
                >
                  ...
                  >
                    <Package
                      size={18}
                      className={`${c.text500} md:w-5 md:h-5`}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-1 md:gap-2 mt-1 md:mt-2">
                    <span
                      className={`text-[10px] md:text-xs px-1.5 py-0.5 md:px-2 rounded-full ${module.status === "Core" ? "bg-green-100 text-green-600" : "bg-orange-100 text-orange-600"}`}
                    >
                      {module.status}
                    </span>
        ...
        <section className="py-10 md:py-16 bg-white border-t border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <Sparkles
                size={24}
                className="text-white mx-auto mb-3 md:w-8 md:h-8"
              />
              ...
              <p className="text-white/90 mb-5 md:mb-6 max-w-md mx-auto text-sm md:text-base">
                Let's discuss how we can help you implement these solutions and
                drive growth.
              </p>
